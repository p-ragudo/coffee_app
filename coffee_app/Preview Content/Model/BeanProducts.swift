...
class BeanProductsProvider {
    static func getItems() -> [BeanProduct] {
        ...
        return [
            ...
            BeanProduct(image: "arabica_card", name: "Kalinga Robusta - Dark Roast", price: 110.00, desc: desc[4], rating: 4.5, numOfSold: 9800),
            ...
            BeanProduct(image: "arabica_card", name: "Batangas Barako (Liberica)", price: 280.00, desc: desc[7], rating: 4.9, numOfSold: 15300),
            ...
            BeanProduct(image: "arabica_card", name: "Excelsa - Single Origin Cavite", price: 160.00, desc: desc[10], rating: 4.6, numOfSold: 3700),
